...
public class Ex04 {
	...
	// 원주율은 3.14로 간주한다
	static double getCircleArea(int redius) {
		double area = redius * redius * 3.14;
		return area;
	}
	
	
	static double getCircleArea(double redius) {
		double area = redius * redius * 3.14;
		return area;
	}
	...
	public static void main(String[] args) {
		...
		// 인자를 2개  전다랗면 begin Index와  endIndex로 취급하여 begin 부터 end이전까지 잘라낸다
	...
	static int add(int n1, int n2) { // 기본정의
		return n1 + n2;
	}
	static double add(int n1, double n2) {	// 자료형이 다른 정의
		return n1 + n2;
	}
	static double add(int n1, int n2, int n3) { // 개수가 다른 정의
		return n1 + n2 + n3;
	}
