...
<h1 style="text-align: center;">ex03 - DTO를 활용한 업로드 + DB저장</h1>
<hr>
...
<div style="display: flex; flex-flow: wrap; width: 660px; margin: auto; border: 1px solid skyblue;">
	<c:forEach var="dto" items="${list }">
		<div class="item" style="margin: 10px; text-align: center; width: 200px; background-color: hotpink	;">
