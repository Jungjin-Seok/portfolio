...
<h3>request와 response는 JSP의 내장객체에 해당한다 (별도 생성이 필료 없음)</h3>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>request에 저장된 내장객체를 이름으로 불러와서 Object로 변환한다</td>
			<td><%= request.getAttribute("today")%></td>
		</tr>
		<tr>
			<td>request.getCookies()</td>
			<td>요청에 담긴 쿠키를 배열 형태로 반환한다. null을 바환할수도 있다</td>
			<td><%=request.getCookies() %></td>
		</tr>
		<tr>
...
<form>
	<p><input name="guest" placeholder="손님입력" required></p>
