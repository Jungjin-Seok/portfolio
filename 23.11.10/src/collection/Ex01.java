...
import java.util.ArrayList; // list를 implement 하는 클래스 ArrayList
...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 리스티 및 컬레션은 대부분 toString()이 오버라이딩되어있어서 바로 출력해도 내용을 확인할 수 있다
...
//		list.remove(30);	// 정수를 그냥 전달하면 index로 간조한다
