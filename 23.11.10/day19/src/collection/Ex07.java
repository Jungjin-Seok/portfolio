...
public class Ex07 {
	public static void main(String[] args) throws IOException {
		...
		for(String Key : KeySet) {
			String value = map.get(Key);	// Key를 알면 value를 구할수 있
			System.out.println(Key + ":" + value);
		}
		System.out.println();
		
		// 다수의 데이터 중에서 원하는 값을 찾아내는 코드이지만 반복
		...
		pro.put("equals", "다름 문자열과 비교하여 내용 일치여부를 boolean으로 반환한다");
