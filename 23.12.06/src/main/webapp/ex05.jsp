...
<ul>
	...
	<li>JSP 내장 객체에 저장해둘 수 있고, 내장객체에 따라 공유 유효범위가 다르다</li>
	<li>서로다른 JSP 페이지가 attribute를 공유할 수 있다</li>
	<li>서버 개발자가 값을 set 혹은 get 할 수 있다</li>
	<li>Object타입을 원하는 형태로 바꾸려면, 형변환(down-casting)을 해야한다</li>
</ul>
