...
<body>
	...
	<details>
		...
		<ul>
			...
			<li>회원 1명당 1번만 참여할 수 있음(unique 활용)</li>
			<li>설문 결과는 비회원 조회가능</li>
	...
	<details>
		...
		<ol>
			...
			<li>스프링에서는 컨트롤러 -> 서비스 -> DAO 형태의 연결이 거의 고정이므로, 미리작성한다</li>
			<li>파일업로드 등, 필요한 스프링 빈이 있으면 추가로 등록한다</li>
			<li>단, 로그인 인터셉터는 기능 구현이 모두 끝난 후 마지막에 추가하여 테스트한다</li>
			<li>대문페이지에서 기능에 대한 링크 (주소 or 이벤트)가 만들어지면, 그에 대한 함수를 작성한다</li>
			<li>함수 작성이 끝나면, 그에 대한 웹 페이지를 작성한다. 단, 대문페이지 및 공통 페이지는 미리 작성한다</li>
		</ol>
	</details>
