...
<section>
	...
	<details>
		<summary>Hash 와 Encryption</summary>
		<hr>
		
		<fieldset>
		
			<p>
				Hash는 기호 # 으로 나타내며, 데이터 파편, 조각낸다는 의미이다<br>
				...
				한번 해시처리된 데이터는 원본으로 되돌릴 수 없으나<br>
				원본이 동일하면 해시값도 동일하다는 턱성이 있어서, 일치 비교에 사용할 수 있다
			</p>
			...
			<p>
				...
				암호화 방식에 따라, 암호화/복호화 키가 동일한 경우는 대칭키 라고 한다<br>
				암하화/복호화 키가 서로 다른 경우는 비대칭키라고 한다<br>
