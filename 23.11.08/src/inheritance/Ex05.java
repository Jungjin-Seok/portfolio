...
class Parent5{ // 두 정수를 전달 받아서, 객체를 생성하고, 덧셈식을 출력하는 클래스
	int n1, n2;
...
class Child5 extends Parent5{
	...
	// 세 정수를 전달받고, 세 정수의 덧셈식을 출력하는 기능을 오버라이딩 하세요 (함수 내용 수정)
	@Override
	public void show() {
...
public class Ex05 {
	public static void main(String[] args) {
		...
		ob1.show(); 		// ob1은 슈퍼 클래스 타입이지만 오버라이딩 메서드가 실행된다
