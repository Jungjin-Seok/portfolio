...
<h3>기존 표현식에서 attribute 및 parameter 값을 출력할 때 코드가 긴 점을 개선한 형태(글자를 출력하는 용도)</h3>


<fieldset>
	<legend>attribute</legend>
	<p>내장객체에 저장된 attribute의 이름을 지정하면 값을 출력한다</p>
	<p>Object 타입의 객체가 저장되므로, 출력시에는 객체의 toStrion() 결과를 출력한다</p>
	...
	<fieldset>
		...
		<p>EL Tag : ${map.apple }, ${map['banana'] }, ${map["banana"] }</p>
	</fieldset>
	<br>
