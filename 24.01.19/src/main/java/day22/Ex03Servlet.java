...
@WebServlet("/ex03") // web.xml에 <servlet>으로 등록하고 <servlet-mapping>으로 경로를 지정한 효과
public class Ex03Servlet extends HttpServlet{
	...
	// 서블릿은 요청 메서드에 따라 doGET 및 doPOST함수를 별도로 사용할 수 있다
	
		@Override	// 처리내용없이 JSP만 보여주면 된다 (곧 바로 포워드)
