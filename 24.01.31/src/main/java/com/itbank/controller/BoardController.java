...
public class BoardController {
	// 사용자에게 요청을 받아서 사용자에게 보여주기 위함(응답)
	...
	@GetMapping("/view/{idx}")
	public ModelAndView modelandview(@PathVariable("idx") int idx) {
	...
	// pathVariable 때문에 viewName을 강제로 지정해야 하면 String 혹은 ModelAndView
