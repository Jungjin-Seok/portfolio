...
public class Ex08 {
	...
	// 프로젝트 우클릭 -> 맨 아래 속성(properties) -> java build path -> Modulepath선택 -> add -> 추가 할 .jar 선택
	
	public static void main(String[] args) throws Exception {
		
		String username = "hr";	// DB접속 계정이름
		String password = "hr";	// DB접속 비밀번호
		String ur1 = "jdbc:oracle:thin:@192.168.1.100:1521:xe";	// DB 접속 주소
